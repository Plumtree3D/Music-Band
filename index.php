...
<body>
<nav><div class="menuburger"></div><div class="musicband"></div><div class="searchbar"></div><div class="user"></div></nav>
<header>
    <div>
    <h1><span>Music</span> Band</h1>
    <p>Votre musique sans pub, partout. Seulement 9,99€/mois ensuite. Soumis à conditions. Des podcasts exclusifs. Des playlists sur-mesure. Faites des découvertes. Zappez à volonté. Plus de 50 milliards de chansons. Annulation tout de suite!</p>
...
<div class="rightFooter">
    ...
    <div class="tel"><p>Par téléphone au: <a href="tel:+33389878586">03 89 87 85 86</a></p></div>
    <div class="mail"><p>Par email au: <a href="mailto:contact@musicband.com">contact@musicband.com</a></p></div>
</div>
    </footer>
